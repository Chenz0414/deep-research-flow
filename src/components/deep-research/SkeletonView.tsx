  ...
  return (
    ...
    >
      ...
      <div className="text-center space-y-1.5">
        <p className="text-sm font-medium text-foreground">正在生成研究计划</p>
      ...
      <div className="w-full max-w-sm space-y-3 px-4 sm:px-8 mt-2">
        {[1, 2, 3, 4].map((i) => (
          <motion.div
            ...
            className="space-y-2"
          >
            <div className="h-4 bg-muted rounded-md animate-pulse" style={{ width: `${85 - i * 8}%`, animationDelay: `${i * 150}ms` }} />
            <div className="h-3 bg-muted/60 rounded-md animate-pulse" style={{ width: `${60 - i * 5}%`, animationDelay: `${i * 150 + 75}ms` }} />
          </motion.div>
        ))}
      </div>
    </motion.div>
