    ...
    <>
      ...
      <div className="sm:hidden fixed bottom-0 left-0 right-0 z-30 bg-card border-t border-border/50 max-h-[40vh] flex flex-col">
        <div className="px-4 py-3 border-b border-border/50 flex items-center gap-2.5">
          <div className={`w-6 h-6 rounded-md flex items-center justify-center ${isActive ? 'bg-primary/10' : 'bg-muted'}`}>
            {isActive ? (
          ...
          <div className="flex-1">
            ...
            <p className={`text-[10px] ${isActive ? 'text-primary' : 'text-muted-foreground'}`}>{status.text}</p>
          </div>
        </div>
      ...
      <div className={`hidden sm:flex h-full flex-col border-l border-border/50 bg-card transition-all duration-200 ${collapsed ? 'w-10' : 'w-full'}`}>
        {collapsed ? (
          <button onClick={() => setCollapsed(false)} className="h-full flex items-center justify-center hover:bg-accent transition-colors cursor-pointer">
          ...
          <>
            <div className="px-5 py-4 border-b border-border/50 flex-shrink-0">
              <div className="flex items-center justify-between">
                ...
                <button onClick={() => setCollapsed(true)} className="p-1 rounded-md hover:bg-accent transition-colors cursor-pointer">
